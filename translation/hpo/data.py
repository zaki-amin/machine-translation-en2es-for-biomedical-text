...
class HPOCorpus(Dataset):
    ...
    def _prep_terms(self, hpo: pronto.Ontology, hpo_id: str, just_labels: bool):
        """Prepare terms as dictionaries of strings, with list items expanding as multiple keys."""
    ...
    def translation_pairs(self):
        return (
            ...
            .rename({"id": "hpo_id", "text": "english", "text_trans": "translation"})
            .select(["hpo_id", "english", "translation"])
